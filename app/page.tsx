...
initial="hidden"
animate="visible"
className="px-4 sm:px-6 md:px-10 py-8 md:py-10 space-y-12 md:space-y-16 backdrop-blur-[1px] max-w-7xl mx-auto relative overflow-hidden"
>
...
<span>
Site by <span className="underline decoration-[#90be6d] decoration-[3px] underline-offset-4">
Nyra
</span>!
</span>
...
whileTap={{ scale:0.9 }}
className="absolute bottom-4 sm:bottom-6 right-4 sm:right-6 bg-[#c45a5a] text-white text-[11px] sm:text-[12px] px-6 sm:px-8 py-3 sm:py-4 rounded-3xl font-[1000] border-[4px] border-[#8b5a2b] uppercase shadow-xl flex items-center gap-2 cursor-pointer z-20"
>
